...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An interactive science simulator for grades 6–9. Explore how everyday materials respond to heat and cold." },
      { name: "author", content: "HeatQuest" },
